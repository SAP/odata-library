...
class QueryableResource extends Resource {
  ...
  post(body) {
    ...
    let payload = this.bodyProperties(body);
    ...
    return defaultBatch
      ...
      : this._handleAgentCall(() => {
          ...
          return this.agent.post(path, this.defaultRequest._headers, payload);
        });
  }
  ...
  put(body) {
    ...
    return defaultBatch
      ...
      : this._handleAgentCall(() => {
          this.header("Content-type", "application/json");
          return this.agent.put(path, this.defaultRequest._headers, payload);
        });
  }
  ...
  merge() {
    ...
    payload = this.bodyProperties(propertiesToChange);
    ...
    return defaultBatch
      ...
      : this._handleAgentCall(() => {
          this.header("Content-type", "application/json");
          return this.agent.merge(path, this.defaultRequest._headers, payload);
        });
  }
