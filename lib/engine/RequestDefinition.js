...
class RequestDefinition {
  ...
  parameter(parameterName, parameterValue) {
    ...
    let parameterDefinition = this._resource.getParameterDefinition(
      parameterName
    );
    this._parameters[parameterName] = parameterDefinition.type.format(
      parameterValue
    );
    return this;
  }
  ...
  get _isList() {
    ...
    let isEntity = _.has(this, "_keyValue") || isNavPropSingle;
